                ...
                <div className="my-10 lg:my-32 px-4 lg:px-10 w-full xl:w-4/5  mx-auto">
                    <div className="w-full flex flex-col justify-center">
                        ...
                        <div className="relative flex flex-col md:flex-row">
                            ...
                            <div
                                className="absolute w-14 h-14 top-[45%] md:top-[33%] left-[42%] md:left-[45%] lg:left-[46%] 2xl:left-[46.7%] animate__animated animate__pulse animate__infinite z-30">
                                <div
                                    className="relative bg-white rounded-full w-14 h-14 flex items-center justify-center animated animate__zoomIn animate__delay-3s opacity-0">
                                    <div
