            ...
            <div
                ...
                <section className="container mx-auto">
                    <div
                        ...
                        <div
                            className="w-full 2xl:w-2/3 mx-auto flex flex-col lg:flex-row space-y-10 lg:space-y-0 lg:space-x-10">
                            <form className="w-full lg:w-1/2 flex flex-col text-white space-y-5"
